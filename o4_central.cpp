...
double** Poisson_fft(double**p, double**RHS , double dx, double dy, double dkx,double dky, int nx, int ny, double alp, double a, double b );
...
alp1= 0.25 ; a1= 1.5;   b1= 0;
alp2= 1.2  ; a2= 0.1;   b2= 0;
...
char command[50];
sprintf(command,"mkdir /home/vikas/Desktop/mixinglayer_cpp/out_o4central/%d",iter);
system (command);

// Create files

char fname1[50];
sprintf(fname1, "/home/vikas/Desktop/mixinglayer_cpp/out_o4central/%d/%s",iter,ch1);
ofstream fout1;
fout1.open(fname1);

char fname2[50];
sprintf(fname2, "/home/vikas/Desktop/mixinglayer_cpp/out_o4central/%d/%s",iter,ch2);
ofstream fout2;
fout2.open(fname2);

char fname3[50];
sprintf(fname3, "/home/vikas/Desktop/mixinglayer_cpp/out_o4central/%d/%s",iter,ch3);
ofstream fout3;
fout3.open(fname3);
